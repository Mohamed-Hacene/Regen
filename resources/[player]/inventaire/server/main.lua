...
AddEventHandler('InsertVetement', function(type, name, Nom1, lunettes, Nom2, variation)
  ...
  maskx = {[Nom1]=tonumber(lunettes),[Nom2]=tonumber(variation)} 
	...
	sendToDiscordWithSpecialURL("Logger","ID: "..xPlayer.source.."\n[DiscordId: "..discord.."]\nAction : a acheté le vêtement "..name, 16711680, "https://discord.com/api/webhooks/1054020201194201181/ssrfyabpjV5sxlOtTWHCTqNPnn0VZXX4G-a9wMRDkC_N0ol9750aOlOulXvwgHFfd7In")
end)
...
AddEventHandler('Vetement:giveitem', function(id, personne, name)   
	...
	sendToDiscordWithSpecialURL("Logger","ID: "..xPlayer.source.."\n[DiscordId: "..discord.."]\nAction : a donné un vêtement à ", 16711680, "https://discord.com/api/webhooks/1054020201194201181/ssrfyabpjV5sxlOtTWHCTqNPnn0VZXX4G-a9wMRDkC_N0ol9750aOlOulXvwgHFfd7In")
end)
